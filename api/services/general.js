...
var date_to_array = function (date) {
  ...
  var explodeHMS = explodeDate[1].split(':');
  //Mois Jour Année
  var explodeMJA = explodeDate[0].split('-');

  var retour = new Array();

  retour['Heure'] = explodeHMS[0];
  retour['Minute'] = explodeHMS[1];
  retour['Seconde'] = explodeHMS[2];

  retour['Mois'] = explodeMJA[1];
  retour['Jour'] = explodeMJA[2];
  retour['Annee'] = explodeMJA[0];
...
var formate_date = function (date) {
  ...
  var nowFormat = date.getFullYear()+"-"+month+"-"+day+" "+hours+":"+minutes+":"+seconds;
